\ 4tH library - GTK server Unix IPC - Copyright 2010,2020 J.L. Bezemer
...
: pid!                                 ( -- n)
  ...
  error? E.LIBERR throw" Cannot start ps" 
  dup use refill 0= E.LIBERR throw" Cannot read ps"
  bl parse-word number error? E.LIBERR throw" Invalid pid" to pid close
;
                                       ( -- h f)
...
: gtk-srv-start                        ( -- , init connection with gtk-server)
  ...
  gtk-connect E.LIBERR throw" Cannot start GTK-server" close
