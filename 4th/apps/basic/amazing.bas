...
1520 if x=2 then push 820 : return
1530 push 860 : return
1540 if x=1 then push 790 : return
1550 if x=2 then push 820 : return
1560 push 910 : return
1570 if x=1 then push 790 : return
1580 if x=2 then push 860 : return
1590 push 910 : return
1600 if x=1 then push 820 : return
1610 if x=2 then push 860 : return
1620 push 910 : return
