...
445 IF D<(A+1) THEN 450
446 GOSUB 720
447 GOTO 440
449 REM *** ENOUGH GRAIN FOR SEED?
450 IF (D/2)<(S+1) THEN 455
452 GOSUB 710
453 GOTO 440
...
552 D=P-C: IF D>(P*45)/100 THEN 560
553 F=((Z-1)*F+D*100/P)/Z
555 P=C: B=B+D: GOTO 215
...
857 GOTO 990
860 PRINT "IN YOUR 10-YEAR TERM OF OFFICE, ";F;" PERCENT OF THE"
862 PRINT "POPULATION STARVED PER YEAR ON THE AVERAGE, I.E. A TOTAL OF"
865 PRINT B;" PEOPLE DIED!!": L=A/P
870 PRINT "YOU STARTED WITH 10 ACRES PER PERSON AND ENDED WITH"
875 PRINT L;" ACRES PER PERSON.": PRINT
880 IF F>33 THEN 565
885 IF L<7 THEN 565
890 IF F>10 THEN 940
892 IF L<9 THEN 940
895 IF F>3 THEN 960
...
965 PRINT "REALLY WASN'T TOO BAD AT ALL. ";(P*8*RND(10))/100;" PEOPLE"
