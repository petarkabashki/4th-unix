...
6 PRINT: PRINT: PRINT
15 GOSUB 1091: GOSUB 2000
16 LET I=60000
17 PRINT "DO YOU WISH TO TRADE FURS? ";
18 GOSUB 1402
20 IF COMP(Q, "YES")=0 THEN 100
21 STOP
100 PRINT
101 PRINT "YOU HAVE ";USING "$?.##";I;" SAVINGS."
102 PRINT "AND 190 FURS TO BEGIN THE EXPEDITION."
261 LET E=RND(15)+95
262 LET B=RND(25)+100
300 PRINT
...
330 FOR J=1 TO 4
333 PRINT
335 PRINT "HOW MANY ";SHOW(@(J+10));" PELTS DO YOU HAVE";
336 INPUT @(J)
337 NEXT J
340 LET @(0)=@(1)+@(2)+@(3)+@(4)
342 IF @(0)<191 THEN 1100
500 PRINT
...
1096 PRINT "ON THE FORT THAT YOU CHOOSE.": PRINT
1099 RETURN
1100 PRINT: PRINT "YOU MAY TRADE YOUR FURS AT FORT 1, FORT 2, OR FORT 3."
1102 PRINT "FORT 1 IS FORT HOCHELAGA (MONTREAL)"
1103 PRINT "AND IS UNDER THE PROTECTION OF THE FRENCH ARMY.": PRINT
1104 PRINT "FORT 2 IS FORT STADACONA (QUEBEC) AND IS UNDER THE"
1105 PRINT "PROTECTION OF THE FRENCH ARMY.  HOWEVER, YOU MUST"
1106 PRINT "MAKE A PORTAGE AND CROSS THE LACHINE RAPIDS.": PRINT
1108 PRINT "FORT 3 IS FORT NEW YORK AND IS UNDER DUTCH CONTROL."
1109 PRINT "YOU MUST CROSS THROUGH IROQUOIS LAND.": PRINT
1110 INPUT "ANSWER 1, 2, OR 3: ";Z: PRINT
1112 IF Z=1 THEN 1120
1113 IF Z=2 THEN 1135
1115 IF Z=3 THEN 1147
1116 GOTO 1110
...
1125 GOSUB 1400
1129 IF COMP(Q, "YES")=0 THEN 1110
1130 GOTO 1160
...
1141 GOSUB 1400
1144 IF COMP(Q, "YES")=0 THEN 1110
1145 GOTO 1198
...
1152 GOSUB 1400
1155 IF COMP(Q, "YES")=0 THEN 1110
1156 GOTO 1250
1160 LET I=I-16000
1169 PRINT
1174 LET M=RND(20)+70
1175 LET E=RND(20)+65
1176 LET B=RND(20)+75
1177 LET D=RND(20)+80
1180 PRINT "SUPPLIES AT FORT HOCHELAGA COST $150.00."
1181 PRINT "YOUR TRAVEL EXPENSES TO HOCHELAGA WERE $10.00."
1190 GOTO 1410
1198 LET I=I-14000
1201 PRINT
1205 LET M=RND(30)+85
1206 LET E=RND(15)+80
1207 LET B=RND(20)+90
1209 LET P=RND(10)+1
1210 IF P<3 THEN 1216
1212 IF P<7 THEN 1224
1213 IF P<9 THEN 1226
1215 IF P<11 THEN 1235
1216 LET @(2)=0
...
1250 LET I=I-10500
1254 PRINT
1260 LET M=RND(15)+105
1263 LET D=RND(25)+110
1270 LET P=RND(10)+1
1271 IF P<3 THEN 1281
1272 IF P<7 THEN 1291
1273 IF P<9 THEN 1295
1274 IF P<11 THEN 1306
...
1402 Q=ASK("ANSWER YES OR NO: ")
1404 RETURN
1410 PRINT
1412 PRINT "YOUR BEAVER SOLD FOR ";USING "$?.##";B*@(2)
1414 PRINT "YOUR FOX SOLD FOR ";USING "$?.##";D*@(4)
1416 PRINT "YOUR ERMINE SOLD FOR ";USING "$?.##";E*@(3)
1417 PRINT "YOUR MINK SOLD FOR ";USING "$?.##";M*@(1)
1418 LET I=M*@(1)+B*@(2)+E*@(3)+D*@(4)+I
1420 PRINT
1422 PRINT "YOU NOW HAVE ";USING "$?.##";I;" INCLUDING YOUR PREVIOUS SAVINGS"
1425 GOTO 508
1430 FOR J=1 TO 4
1432 LET @(J)=0
1434 NEXT J
1436 RETURN
2000 @(11)=DUP("MINK"):   @(12)=DUP("BEAVER")
2010 @(13)=DUP("ERMINE"): @(14)=DUP("FOX"): RETURN
2046 END
