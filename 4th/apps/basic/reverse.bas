...
150 N=9
160 INPUT "DO YOU WANT THE RULES (1=Y, 0=N): ";A
180 IF A=0 THEN 210
190 GOSUB 710
...
230 @(K)=RND(N)+1
240 FOR J=1 TO K-1
250 IF @(K)=@(J) THEN UNLOOP : GOTO 230
260 NEXT J:NEXT K
