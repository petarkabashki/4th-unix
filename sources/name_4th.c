...
| Removed STARSLSH, added RCOPY2, changed RCOPY3   | J.L. Bezemer     |100617|
| Removed LEAVE, added RDROP                       | J.L. Bezemer     |280719|
+--------------------------------------------------+------------------+------+
...
+--------------------------------------------------+------------------+------+
  ...
  Copyright (C) 1997,2019 J.L. Bezemer
...
const char* const name_4th [] = {
  ...
  "?do",         "do",       "loop",     "+loop",    "close",     "open",
  "use",         "+!",       "/mod",     "exit",     "rdrop",     "r\'@",
  "r\"@",        ".r",       "number",   "variable", "-trailing", "call",
